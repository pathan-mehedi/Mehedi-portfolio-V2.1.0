...
// The PrivacyPolicy component is defined here for a self-contained page
const PrivacyPolicy = () => {
  return (
    <main>
      <HeaderUnified />
...
// The main page component that renders the PrivacyPolicy
