...
// This component renders the full Terms and Conditions content.
  ...
  return (
    <main>
      ...
      <div className="container mx-auto p-8 max-w-4xl">
        ...
        <p className="text-gray-600 mb-6">Last updated: August 14, 2025</p>
        ...
        <ul className="list-disc list-inside space-y-2 mb-6">
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Mehedi Pathan Portfolio.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Mehedi Pathan Portfolio, accessible from <a href="https://www.mehedipathan.online" rel="external nofollow noopener" target="_blank" className="text-blue-500 hover:underline">https://www.mehedipathan.online</a></p>
          </li>
          <li>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">For European Union (EU) Users</h2>
        ...
        <h2 className="text-2xl font-bold mt-8 mb-4">United States Legal Compliance</h2>
        ...
        <ul className="list-disc list-inside space-y-2 mb-6">
          <li>
            <p>By email: <a href="mailto:mehedipathantext@gmail.com" className="text-blue-500 hover:underline">mehedipathantext@gmail.com</a></p>
          </li>
          <li>
            <p>By visiting this page on our website: <a href="https://www.mehedipathan.online" rel="external nofollow noopener" target="_blank" className="text-blue-500 hover:underline">https://www.mehedipathan.online</a></p>
          </li>
        </ul>
      </div>
      <Footer />
...
// The main page component that renders the TermsAndConditions
